-- Fix the claim_gift_card function to cast gift_card.id to text properly
...
BEGIN
  ...
  -- Record in history - use UUID directly, not text cast
  INSERT INTO cardboom_points_history (user_id, amount, transaction_type, source, description)
  VALUES (auth.uid(), gift_card.gem_amount, 'earn', 'gift_card', 'Gift card claimed: ' || gift_card.code);
