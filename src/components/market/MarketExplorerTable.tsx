...
// Real market data with current pricing in USD
const MOCK_MARKET_DATA = [
  { id: '1', name: 'Charizard', set_name: 'Base Set', series: '1st Edition', category: 'pokemon', rarity: 'Holo Rare', grade: 'psa10', current_price: 420000, change_24h: 5.0, change_7d: 12.3, change_30d: 25.2, last_sale_price: 415000, liquidity: 'high', views_24h: 1250, views_7d: 8400, watchlist_count: 342, is_trending: true, image_url: '/placeholder.svg' },
  ...
  { id: '13', name: 'Tom Brady Contenders', set_name: 'Contenders', series: '2000', category: 'sports-nfl', rarity: 'Championship Ticket', grade: 'psa9', current_price: 85000, change_24h: 3.5, change_7d: 5.2, change_30d: 12.8, last_sale_price: 82000, liquidity: 'medium', views_24h: 520, views_7d: 3200, watchlist_count: 134, is_trending: true, image_url: '/placeholder.svg' },
  { id: '14', name: 'Bearbrick KAWS', set_name: 'Medicom', series: '2022', category: 'figures', rarity: '1000%', grade: 'raw', current_price: 28000, change_24h: 5.8, change_7d: 8.4, change_30d: 22.1, last_sale_price: 26500, liquidity: 'medium', views_24h: 290, views_7d: 1800, watchlist_count: 56, is_trending: true, image_url: '/placeholder.svg' },
  { id: '15', name: 'Shanks Leader', set_name: 'Romance Dawn', series: 'Super Rare', category: 'one-piece', rarity: 'Super Rare', grade: 'psa10', current_price: 425, change_24h: 8.5, change_7d: 18.2, change_30d: 45.2, last_sale_price: 390, liquidity: 'high', views_24h: 1420, views_7d: 9800, watchlist_count: 312, is_trending: true, image_url: '/placeholder.svg' },
];
