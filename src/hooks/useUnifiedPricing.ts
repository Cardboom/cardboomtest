 ...
 * 
 * Rules:
 * - Boom Coins are ALWAYS in fixed USD conversion (1 Boom Coin = $0.105 USD)
 * - When displayMode is 'gems': Show price in Boom Coins (~9.5 coins per $1)
