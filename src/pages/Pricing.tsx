  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {/* Grading CTA */}
        <div className="max-w-4xl mx-auto mt-20 pt-12 border-t border-border/50">
          <Card className="p-8 text-center bg-gradient-to-r from-primary/10 to-amber-500/10 border-primary/30">
            <Award className="w-12 h-12 mx-auto mb-4 text-primary" />
            <h2 className="text-2xl font-bold mb-2">Looking for Grading Services?</h2>
            <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
              Check out our CBGI Grading page for AI pre-grading and full physical certification with ultrasonic welded slabs.
            </p>
            <Button onClick={() => navigate('/grading')} size="lg">
              View Grading Prices
